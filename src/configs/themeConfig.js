...
const themeConfig = {
  ...
  navigationSize: 280 /* 260 Number in px(Pixels) /*! Note: This is for Vertical navigation menu only */,
  collapsedNavigationSize: 58 /* 68 Number in px(Pixels) /*! Note: This is for Vertical navigation menu only */,
