        ...
        <DialogContent sx={{ pb: 12, mx: 'auto' }}>
          <Box component='form' sx={{ mt: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
            ...
            >
              ...
              <MenuItem value='Form-Request'>Form-Request</MenuItem>
              <MenuItem value='Event'>Event</MenuItem>
              <MenuItem value='Mail'>Mail</MenuItem>
              <MenuItem value='AttendanceDays'>Attendance Days</MenuItem>
              <MenuItem value='AttendanceShift'>Attendance Shift</MenuItem>
